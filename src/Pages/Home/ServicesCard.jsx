...
const ServicesCard = ({ services }) => {
  const { category, details, id, image ,price} = services;
  return (
    <div data-aos="flip-left" data-aos-easing="linear" data-aos-duration="1000">
      
      <div className="relative lg:h-[500px] flex  px-2 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
